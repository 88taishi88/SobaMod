...
public class GreenOnion extends BlockCrops implements IPlantable, IGrowable {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		...
		for (int i = 0; i < this.iconArray.length; i++) {
			this.iconArray[i] = iconRegister.registerIcon("noodlesmod:green_onion_" + (i + 1));
		}
	}
	...
	protected Item func_149866_i() {
		return RegisterItem.greenOnion;//種
	}

	protected Item func_149865_P() {
		return RegisterItem.greenOnion;//作物
	}
